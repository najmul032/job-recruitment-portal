...
import { Building, Mail, Phone, FileText, Save, ArrowLeft, CheckCircle, AlertCircle } from 'lucide-react';
...
setFormData({
  ...
  contact_info: response.data.profile?.contact_info || '',
      ...
      <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200/60 border border-slate-100 overflow-hidden">
        <div className="bg-slate-50/50 px-10 py-10 border-b border-slate-100">
          <div className="flex items-center gap-5">
            ...
            <div>
              <h1 className="text-3xl font-display font-bold text-slate-900 leading-tight">Company Profile</h1>
              <p className="text-slate-500 font-medium tracking-tight">Manage your company's public information and branding.</p>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">Admin Name</label>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <Building className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary-600 transition-colors" size={20} />
                <input
                  name="company_name"
                  type="text"
                  required
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">Contact Information</label>
              <div className="relative group">
                ...
                <input
                  ...
                  type="text"
                  className="w-full pl-14 pr-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500 outline-none transition-all font-medium text-slate-900 placeholder:text-slate-400"
                  placeholder="e.g. +1 234 567 890, contact@tech.com"
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">Company Description</label>
              <div className="relative group">
                <FileText className="absolute left-5 top-6 text-slate-400 group-focus-within:text-primary-600 transition-colors" size={20} />
                <textarea
